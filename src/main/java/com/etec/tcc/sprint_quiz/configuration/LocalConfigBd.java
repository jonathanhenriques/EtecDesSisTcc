...
/**
 * classe para povoar o banco h2 quando em abiente local usando
...
//        Usuario usuario1 = new Usuario(null, "Jonathan", "jonathan@email.com", "12345678", "", 0, permissions, roles, new ArrayList<Questao>(), new ArrayList<Prova>());
		...
		CategoriaProva cp = new CategoriaProva(null, "Categoria Prova teste", "Descrição categoriaProva",
				Arrays.asList(new Prova()));
		CategoriaProva cp1 = new CategoriaProva(null, "Categoria Prova teste 2", "Descrição categoriaProva 2",
				Arrays.asList(new Prova()));
		...
		Questao questao1 = new Questao(null, "instituicao ", LocalDate.now(), "imagem", "Texto questão teste",
				DificuldadeQuestao.FACIL, null, null, cq1, usuario1);
		...
		Alternativa a3 = new Alternativa(null, "texto alternativa c", "", questao2);
